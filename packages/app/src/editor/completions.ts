...
const MODULES: BuiltinDoc[] = [
  ...
  { label: 'translate', template: 'translate([${0}, ${0}, ${0}])', detail: 'translate(v)', info: 'Moves children by a vector.', type: 'class' },
  { label: 'rotate', template: 'rotate([${0}, ${0}, ${0}])', detail: 'rotate(a, v)', info: 'Rotates children. `rotate(a)` rotates about Z; `rotate(a, v)` about an axis.', type: 'class' },
  ...
  { label: 'mirror', template: 'mirror([${1}, ${0}, ${0}])', detail: 'mirror(v)', info: 'Mirrors children across the plane with normal `v`.', type: 'class' },
