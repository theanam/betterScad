...
| `cylinder(…, fillet)`<br>`fillet1`, `fillet2`, `fillet_style` | Takes the rim off either end — cut flat by default, or `fillet_style = "round"`. `1` is the bottom and `2` the top, as with `r1`/`r2` | A revolve of the same profile |
